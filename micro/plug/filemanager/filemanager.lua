...
local function refresh_view()
	...
	-- An ASCII separator
	tree_view.Buf.EventHandler:Insert(buffer.Loc(0, 1), repeat_str("─", 300) .. "\n")
...
function init()
    ...
    -- edit by pmarreck: I don't care, I don't know how to configure you because you didn't instruct the user on where to put filemanager settings so I'm hardcoding it
